class main extends Phaser.Scene {
    ...
    preload() {
        ...
        let gm = new GameManager(this);
        gm.preloadAssets(); // This loads Bgm.mp3, correct.mp3, and wrong.mp3
    ...
    create() {
        ...
        console.log('*** Initialization Complete. Waiting for Font...');

        // --- 5. THE FONT & SCENE JUMP ---
        // We add a tiny delay (100ms). This gives the browser time to 
        // "inject" the Determination font from your HTML into the game engine.
