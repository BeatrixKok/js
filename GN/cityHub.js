class cityHub extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("marketHint", "assets/Market_Hint.png");
    }
    ...
    create() {
        ...
        let c_building = map.createLayer("c_building", tilesArray, 0, 0);
        let c_prop = map.createLayer("c_prop", tilesArray, 0, 0);
        c_prop.setPosition(32, 0);

        //Collisions
        c_building.setCollisionByExclusion(-1, true);
        c_prop.setCollisionByExclusion(-1, true);
        ...
        let hint = this.add.image(18, 80, "marketHint").setOrigin(0, 0);
        hint.setScrollFactor(0);
        //Collision
        this.physics.add.collider(this.player, c_building);
        this.physics.add.collider(this.player, c_prop);
